    ...
    <Grid container spacing={2} sx={{ maxWidth: "md" }}>
      <Grid item xs={12} md={12}>
        ...
        <Typography>
          ...
          hjälp av lightning. Här visar vi hur du kommer igång med att använda
          en webbplånbok. Häng med!
        </Typography>
      </Grid>
      <Grid item xs={12} md={12}>
      ...
      <Snackbar open={alert} autoHideDuration={10000} onClose={handleClose}>
        <Alert onClose={handleClose} severity="error" variant="filled" sx={{maxWidth: "80vw"}}>
          Något gick fel med betalningen. Försök igen senare. Hör av er till oss om felet består.
        </Alert>
      </Snackbar>
    </Grid>
  );
